...
import { BrandContainer, BrandCard, BrandHeading, BrandText, BrandSpinner } from '../components/branding';
        ...
        {orders.length === 0 ? (
          <BrandCard>
            <div className="text-center py-12">
              ...
              <BrandHeading size="small" className="mb-2">No orders yet</BrandHeading>
