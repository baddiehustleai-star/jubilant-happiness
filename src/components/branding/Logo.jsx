...
export const Logo = ({ size = 'default', variant = 'default', className = '' }) => {
  ...
  return (
    <h1 className={`font-diamond font-bold tracking-wide ${sizeClasses[size]} ${variantClasses[variant]} ${className}`}>
      PHOTO2PROFIT
    </h1>
  );
};
...
export const LogoWithIcon = ({ size = 'default', variant = 'default', className = '' }) => {
  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      <div className={`${iconSizes[size]} bg-brand-gradient rounded-lg flex items-center justify-center shadow-brand`}>
...
export const LogoMark = ({ size = 'default', className = '' }) => {
  ...
  return (
    <div className={`${sizeClasses[size]} bg-brand-gradient rounded-xl flex items-center justify-center shadow-brand-lg ${className}`}>
