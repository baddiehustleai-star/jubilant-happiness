...
export const onCrossPostComplete = onDocumentUpdated(
  'listings/{listingId}',
  async (event) => {
    try {
      const listingId = event.params.listingId;
      ...
      const hasCrossPostResults = afterData.crossPostResults && Object.keys(afterData.crossPostResults).length > 0;
