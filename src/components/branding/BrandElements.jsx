...
export const BrandButton = ({
  ...
  const baseClasses =
    'font-semibold rounded-full transition-all duration-300 focus:outline-none focus:ring-4';
  ...
  const variantClasses = {
    primary:
      'bg-brand-gradient text-white shadow-brand hover:scale-105 hover:shadow-brand-lg focus:ring-rose-200',
    secondary:
      'bg-white text-rose-600 border-2 border-rose-500 hover:bg-rose-50 hover:scale-105 focus:ring-rose-200',
    gold: 'bg-gold-gradient text-white shadow-gold hover:scale-105 hover:shadow-gold-lg focus:ring-gold-200',
    outline:
      'border-2 border-rose-500 text-rose-500 hover:bg-rose-500 hover:text-white hover:scale-105 focus:ring-rose-200',
...
export const BrandBadge = ({ children, variant = 'primary', size = 'default', className = '' }) => {
...
export const BrandInput = ({ label, error, helper, className = '', ...props }) => {
  return (
...
export const BrandContainer = ({ children, size = 'default', className = '' }) => {
  const sizeClasses = {
    sm: 'max-w-4xl',
    default: 'max-w-7xl',
    lg: 'max-w-none',
